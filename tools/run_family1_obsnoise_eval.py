...
RUN_SPECS = {
    "ppo": {
        "exp_prefix": "easy_multi_ppo_obsnoise",
        "checkpoint": ROOT / "checkpoints" / "experiment_family_1" / "easy_lite_ppo_seed101" / "best_model.zip",
        "config_by_k": {
            1: ROOT / "config" / "tasks" / "Nav" / "easy" / "algo" / "multi_shared_ppo_test_k1_obsnoise.yaml",
            2: ROOT / "config" / "tasks" / "Nav" / "easy" / "algo" / "multi_shared_ppo_test_k2_obsnoise.yaml",
            3: ROOT / "config" / "tasks" / "Nav" / "easy" / "algo" / "multi_shared_ppo_test_k3_obsnoise.yaml",
        },
        "result_dir_fmt": "ppo_obsnoise_k{k}",
    },
    "plpg_coarse": {
        "exp_prefix": "easy_multi_plpg_obsnoise",
        "checkpoint": ROOT / "checkpoints" / "experiment_family_1" / "easy_lite_plpg_seed101" / "best_model.zip",
        "config_by_k": {
            1: ROOT / "config" / "tasks" / "Nav" / "easy" / "algo" / "multi_shared_plpg_test_k1_obsnoise.yaml",
            2: ROOT / "config" / "tasks" / "Nav" / "easy" / "algo" / "multi_shared_plpg_test_k2_obsnoise.yaml",
            3: ROOT / "config" / "tasks" / "Nav" / "easy" / "algo" / "multi_shared_plpg_test_k3_obsnoise.yaml",
        },
        "result_dir_fmt": "plpg_obsnoise_k{k}",
    },
    "plpg_fine": {
        "exp_prefix": "easy_multi_plpg_fine_obsnoise",
        "checkpoint": ROOT / "checkpoints" / "experiment_family_1" / "easy_lite_plpg_seed101" / "best_model.zip",
        "config_by_k": {
            1: ROOT / "config" / "tasks" / "Nav" / "easy" / "algo" / "multi_shared_plpg_fine_test_k1_obsnoise.yaml",
            2: ROOT / "config" / "tasks" / "Nav" / "easy" / "algo" / "multi_shared_plpg_fine_test_k2_obsnoise.yaml",
            3: ROOT / "config" / "tasks" / "Nav" / "easy" / "algo" / "multi_shared_plpg_fine_test_k3_obsnoise.yaml",
        },
        "result_dir_fmt": "plpg_fine_obsnoise_k{k}",
    },
}


def parse_args():
    parser = argparse.ArgumentParser(description="Run Family 1 noisy-observation evaluations for K=1,2,3.")
    parser.add_argument(
        "--methods",
