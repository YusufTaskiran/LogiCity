...
% --TO BE FILLED IN--
\noindent
\textbf{Student name:} Yusuf Taskiran \hfill \textbf{Student number:} R0892099
...
\textbf{Title Bachelor’s or Master’s thesis:} &
\begin{minipage}[t]{10cm}
Towards Safer Autonomous Navigation:\\
Neurosymbolic Multi-agent RL in LogiCity Simulator
\end{minipage}
\\[1em]

\textbf{Supervisor:} &
\begin{minipage}[t]{10cm}
Prof.dr.ir. Luc de Raedt \& Prof.dr.ir. Giuseppe Marra
\end{minipage}
\\
...
\textbf{Daily supervisor:} Ir. Ying Jiao \& Ir. Bahare Salmani
...
\textbf{As a language assistant for reviewing or improving texts I wrote myself} & \textit{Yes, ChatGPT} & This use is similar to using spelling and grammar check tools. In general, you do not have to refer to such kind of GenAI use in the text. 
...
\end{itemize} \\ \hline
\textbf{For literature search} & \textit{Yes, ChatGPT} & This use is comparable to e.g.\ a Google Scholar search. You do not have to refer to such kind of GenAI use; \textbf{you only have to \href{https://bib.kuleuven.be/english/training-and-tutorials/citation}{refer} to the literature references you have checked and used} (without such references you would be committing \href{https://www.kuleuven.be/english/education/plagiarism/index}{plagiarism} and thus committing an irregularity).
...
\end{itemize} \\ \hline
\textbf{For generating visuals, video or audio} & \textit{No} & Use of GenAI for generating visuals, audio or video is allowed except when it is prohibited by the teacher or the program of study. 
